# heightfield_quickshade Python Implementation

## Status

| Field | Value |
| --- | --- |
| Node | `heightfield_quickshade` |
| Source context | `TBD` |
| Fidelity | `stub` |
| Native count | `2` |
...
TODO: Document the Houdini behavior for `heightfield_quickshade` before replacing the stub.
