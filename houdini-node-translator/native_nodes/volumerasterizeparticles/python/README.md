# volumerasterizeparticles Python Implementation

## Status

| Field | Value |
| --- | --- |
| Node | `volumerasterizeparticles` |
| Source context | `TBD` |
| Fidelity | `stub` |
| Native count | `3` |
...
TODO: Document the Houdini behavior for `volumerasterizeparticles` before replacing the stub.
