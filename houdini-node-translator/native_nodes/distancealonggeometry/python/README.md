# distancealonggeometry Python Implementation

## Status

| Field | Value |
| --- | --- |
| Node | `distancealonggeometry` |
| Source context | `TBD` |
| Fidelity | `stub` |
| Native count | `24` |
...
TODO: Document the Houdini behavior for `distancealonggeometry` before replacing the stub.
