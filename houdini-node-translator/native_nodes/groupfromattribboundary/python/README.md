# groupfromattribboundary Python Implementation

## Status

| Field | Value |
| --- | --- |
| Node | `groupfromattribboundary` |
| Source context | `TBD` |
| Fidelity | `stub` |
| Native count | `6` |
...
TODO: Document the Houdini behavior for `groupfromattribboundary` before replacing the stub.
