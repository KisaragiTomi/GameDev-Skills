# heightfield_resample Python Implementation

## Status

| Field | Value |
| --- | --- |
| Node | `heightfield_resample` |
| Source context | `TBD` |
| Fidelity | `stub` |
| Native count | `7` |
...
TODO: Document the Houdini behavior for `heightfield_resample` before replacing the stub.
