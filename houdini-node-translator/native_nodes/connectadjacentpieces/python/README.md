# connectadjacentpieces Python Implementation

## Status

| Field | Value |
| --- | --- |
| Node | `connectadjacentpieces` |
| Source context | `TBD` |
| Fidelity | `stub` |
| Native count | `23` |
...
TODO: Document the Houdini behavior for `connectadjacentpieces` before replacing the stub.
