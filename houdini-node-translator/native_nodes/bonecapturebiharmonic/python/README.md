# bonecapturebiharmonic Python Implementation

## Status

| Field | Value |
| --- | --- |
| Node | `bonecapturebiharmonic` |
| Source context | `TBD` |
| Fidelity | `stub` |
| Native count | `4` |
...
TODO: Document the Houdini behavior for `bonecapturebiharmonic` before replacing the stub.
