# extrapolateboundaries Python Implementation

## Status

| Field | Value |
| --- | --- |
| Node | `extrapolateboundaries` |
| Source context | `TBD` |
| Fidelity | `stub` |
| Native count | `21` |
...
TODO: Document the Houdini behavior for `extrapolateboundaries` before replacing the stub.
