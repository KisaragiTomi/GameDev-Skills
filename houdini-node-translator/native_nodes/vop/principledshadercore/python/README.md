# principledshadercore Python Implementation

## Status

| Field | Value |
| --- | --- |
| Node | `principledshadercore` |
| Source context | `Vop` |
| Fidelity | `stub` |
| Native count | `3` |
...
TODO: Document the Houdini behavior for `principledshadercore` before replacing the stub.
