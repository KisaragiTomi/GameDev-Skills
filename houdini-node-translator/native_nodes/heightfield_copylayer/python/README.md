# heightfield_copylayer Python Implementation

## Status

| Field | Value |
| --- | --- |
| Node | `heightfield_copylayer` |
| Source context | `TBD` |
| Fidelity | `stub` |
| Native count | `5` |
...
TODO: Document the Houdini behavior for `heightfield_copylayer` before replacing the stub.
