# particlefluidsurface Python Implementation

## Status

| Field | Value |
| --- | --- |
| Node | `particlefluidsurface` |
| Source context | `TBD` |
| Fidelity | `stub` |
| Native count | `2` |
...
TODO: Document the Houdini behavior for `particlefluidsurface` before replacing the stub.
