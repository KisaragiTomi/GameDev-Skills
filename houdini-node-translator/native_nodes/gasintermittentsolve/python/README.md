# gasintermittentsolve Python Implementation

## Status

| Field | Value |
| --- | --- |
| Node | `gasintermittentsolve` |
| Source context | `TBD` |
| Fidelity | `stub` |
| Native count | `4` |
...
TODO: Document the Houdini behavior for `gasintermittentsolve` before replacing the stub.
