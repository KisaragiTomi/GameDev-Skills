# volumerasterizeattributes Python Implementation

## Status

| Field | Value |
| --- | --- |
| Node | `volumerasterizeattributes` |
| Source context | `TBD` |
| Fidelity | `stub` |
| Native count | `3` |
...
TODO: Document the Houdini behavior for `volumerasterizeattributes` before replacing the stub.
...
result = evaluate(inputs={}, params={}, context={})
```
